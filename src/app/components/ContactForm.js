  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-1/4 -right-12 w-48 h-48 bg-gradient-to-br from-violet-100 to-fuchsia-50 rounded-full mix-blend-multiply filter blur-3xl opacity-20" />
      </div>
        ...
        <div className="lg:col-span-7 relative">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder=" "
                    className="pl-10 w-full p-3 rounded-lg border border-gray-200 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all peer"
                  />
                  <label className="absolute left-10 -top-2.5 bg-white px-1 text-xs font-medium text-cyan-600 peer-placeholder-shown:text-gray-500 peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-focus:-top-2.5 peer-focus:text-xs peer-focus:text-cyan-600 transition-all">
                    Full Name
                  </label>
                </div>
              ...
              <div className="relative mb-5">
                <div className="absolute -top-2.5 left-3 bg-white px-1 text-xs font-medium text-cyan-600 opacity-0 peer-focus:opacity-100 transition-opacity">
                  Your Message
                </div>
                <textarea
                  name="message"
                  ...
                  onChange={handleChange}
                  placeholder=" "
                  className="w-full p-4 rounded-lg border border-gray-200 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all peer pt-4"
                ></textarea>
              ...
              <div className="mb-6">
                <div
                  ...
                  className={`relative rounded-xl border-2 border-dashed p-5 transition-all duration-300 ${
                    file
